...
extern "C" __declspec(dllexport) BSTR DllRun_k_Gol(int *dev_out, int *dev_in, unsigned int span);
...
extern "C" __declspec(dllexport) BSTR DllRun_k_Ising_bp(int *dataOut, int *energyOut, unsigned int *index_rands, float *temp_rands, unsigned int block_size, unsigned int blocks_per_span, float *tts);
