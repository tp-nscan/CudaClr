...
namespace Utils.Ga.Parts
{
    ...
    public static class GaSortingDataCore
    {
        ...
        public static string kSeed = "kSeed";

        public static int GetSeed(this Dictionary<string, object> dictionary)
        {
            return (int)dictionary[kSeed];
        }

        public static void SetSeed(this Dictionary<string, object> dictionary, int seed)
        {
            dictionary[kSeed] = seed;
        }
